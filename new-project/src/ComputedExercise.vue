<template>
  ...
  <div class="contain">
    ...
    <div class="new">
      ...
      <button @submit.prevent="addBlogPost" type="submit">Add New Blog Post</button>
      </form>
    </div>
...
export default {
  ...
  computed:{
    filteredByLabel(){
      return this.posts.filter(post => post.label === this.selected)
    }
  },

  methods: {
    addBlogPost(){
      console.log("hello in herer")
      // if(!this.newTitle || !this.newAuthor || this.newLabel){
